          ...
          <div className="flex max-w-[980px] flex-col items-start gap-2">
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl">
              ...
              <button 
                ...
                className={`hover:text-primary transition-colors ${theme === 'light' ? 'text-primary' : 'text-muted-foreground'}`}
              >
                Day
              </button>
              ,
              ...
              <button 
                ...
                className={`hover:text-primary transition-colors ${theme === 'dark' ? 'text-primary' : 'text-muted-foreground'}`}
              >
                Night
              </button>
              .
